        ...
        <div class = "description-container">
            ...
            <div class = "bio-description">
                    <?php
                        ...
                        print "<textarea id='description' name='description' class='description-textarea'>{$description}</textarea><br>";

                        //Sets the address if one exists
                        print "<h3>Company Address:</h3>";
                        $address = '';
                        if(isset($_COOKIE['address'])) $address = $_COOKIE['address'];
                        print "<textarea id='description' name='address' class='description-textarea'>{$address}</textarea><br>";
